...
<div class="wrap omniprivacy-wrap">
	<div class="omniprivacy-page-header">
		...
		<div class="omniprivacy-page-meta">
			...
			<p class="omniprivacy-page-desc"><?php esc_html_e( 'Aper\u00e7u de conformit\u00e9 et exports pour vos audits RGPD.', 'omniprivacy-pro' ); ?></p>
		</div>
	</div>
	...
	<div class="omniprivacy-card">
		...
		<p><?php esc_html_e( 'T\u00e9l\u00e9chargez le rapport d\'audit complet ou le registre des consentements.', 'omniprivacy-pro' ); ?></p>
	...
	<div class="omniprivacy-dashboard-cards">
		...
		<div class="omniprivacy-card">
			...
			<span class="omniprivacy-score-label"><?php esc_html_e( 'Donn\u00e9es expos\u00e9es', 'omniprivacy-pro' ); ?></span>
		</div>
		...
		<div class="omniprivacy-card">
			...
			<p class="omniprivacy-integrity <?php echo $integrity['is_valid'] ? 'ok' : 'fail'; ?>">
				<?php if ( $integrity['is_valid'] ) : ?>
					<?php esc_html_e( 'Int\u00e9grit\u00e9 OK', 'omniprivacy-pro' ); ?>
				<?php else : ?>
	...
	<div class="omniprivacy-card-stack">
		...
		<?php if ( ! empty( $pii_by_pattern ) ) : ?>
			<div class="omniprivacy-card">
				<h3><?php esc_html_e( 'PII par type', 'omniprivacy-pro' ); ?></h3>
		...
		<div class="omniprivacy-card">
			<h3><?php esc_html_e( 'Derniers consentements', 'omniprivacy-pro' ); ?></h3>
