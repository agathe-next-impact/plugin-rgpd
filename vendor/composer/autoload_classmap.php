...
return array(
    ...
    'OmniPrivacy_Activator' => $baseDir . '/includes/class-omniprivacy-activator.php',
    'OmniPrivacy_Audit_Logger' => $baseDir . '/includes/class-omniprivacy-audit-logger.php',
    'OmniPrivacy_CF7_Scanner' => $baseDir . '/modules/compat/class-cf7-scanner.php',
    'OmniPrivacy_Comment_Anonymizer' => $baseDir . '/modules/data-clean/class-comment-anonymizer.php',
    'OmniPrivacy_Consent_Log' => $baseDir . '/modules/reporting/class-consent-log.php',
    'OmniPrivacy_Data_Viewer' => $baseDir . '/modules/user-portal/class-data-viewer.php',
    'OmniPrivacy_Deactivator' => $baseDir . '/includes/class-omniprivacy-deactivator.php',
    'OmniPrivacy_Deletion_Request' => $baseDir . '/modules/user-portal/class-deletion-request.php',
    'OmniPrivacy_Encryption' => $baseDir . '/includes/class-omniprivacy-encryption.php',
    'OmniPrivacy_Erasure_Certificate' => $baseDir . '/modules/reporting/class-erasure-certificate.php',
    'OmniPrivacy_Exif_Stripper' => $baseDir . '/modules/data-clean/class-exif-stripper.php',
    'OmniPrivacy_Legal_Shield' => $baseDir . '/modules/compat/class-legal-shield.php',
    'OmniPrivacy_Loader' => $baseDir . '/includes/class-omniprivacy-loader.php',
    'OmniPrivacy_Log_Rotator' => $baseDir . '/modules/data-clean/class-log-rotator.php',
    'OmniPrivacy_Magic_Link' => $baseDir . '/modules/user-portal/class-magic-link.php',
    'OmniPrivacy_PDF_Generator' => $baseDir . '/modules/reporting/class-pdf-generator.php',
    'OmniPrivacy_PII_Actions' => $baseDir . '/modules/pii-search/class-pii-actions.php',
    'OmniPrivacy_PII_Field_Scanner' => $baseDir . '/modules/compat/trait-pii-field-scanner.php',
    'OmniPrivacy_PII_Results' => $baseDir . '/modules/pii-search/class-pii-results.php',
    'OmniPrivacy_PII_Scanner' => $baseDir . '/modules/pii-search/class-pii-scanner.php',
    'OmniPrivacy_Portal_Shortcode' => $baseDir . '/modules/user-portal/class-portal-shortcode.php',
    'OmniPrivacy_Settings' => $baseDir . '/includes/class-omniprivacy-settings.php',
    'OmniPrivacy_WPForms_Scanner' => $baseDir . '/modules/compat/class-wpforms-scanner.php',
    'OmniPrivacy_WooCommerce_Scanner' => $baseDir . '/modules/compat/class-woocommerce-scanner.php',
