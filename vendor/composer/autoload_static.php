...
class ComposerStaticInit02f24d5412d2ae22b900a4f2f7ff712b
{
    ...
    public static $classMap = array (
        ...
        'OmniPrivacy_Activator' => __DIR__ . '/../..' . '/includes/class-omniprivacy-activator.php',
        'OmniPrivacy_Audit_Logger' => __DIR__ . '/../..' . '/includes/class-omniprivacy-audit-logger.php',
        'OmniPrivacy_CF7_Scanner' => __DIR__ . '/../..' . '/modules/compat/class-cf7-scanner.php',
        'OmniPrivacy_Comment_Anonymizer' => __DIR__ . '/../..' . '/modules/data-clean/class-comment-anonymizer.php',
        'OmniPrivacy_Consent_Log' => __DIR__ . '/../..' . '/modules/reporting/class-consent-log.php',
        'OmniPrivacy_Data_Viewer' => __DIR__ . '/../..' . '/modules/user-portal/class-data-viewer.php',
        'OmniPrivacy_Deactivator' => __DIR__ . '/../..' . '/includes/class-omniprivacy-deactivator.php',
        'OmniPrivacy_Deletion_Request' => __DIR__ . '/../..' . '/modules/user-portal/class-deletion-request.php',
        'OmniPrivacy_Encryption' => __DIR__ . '/../..' . '/includes/class-omniprivacy-encryption.php',
        'OmniPrivacy_Erasure_Certificate' => __DIR__ . '/../..' . '/modules/reporting/class-erasure-certificate.php',
        'OmniPrivacy_Exif_Stripper' => __DIR__ . '/../..' . '/modules/data-clean/class-exif-stripper.php',
        'OmniPrivacy_Legal_Shield' => __DIR__ . '/../..' . '/modules/compat/class-legal-shield.php',
        'OmniPrivacy_Loader' => __DIR__ . '/../..' . '/includes/class-omniprivacy-loader.php',
        'OmniPrivacy_Log_Rotator' => __DIR__ . '/../..' . '/modules/data-clean/class-log-rotator.php',
        'OmniPrivacy_Magic_Link' => __DIR__ . '/../..' . '/modules/user-portal/class-magic-link.php',
        'OmniPrivacy_PDF_Generator' => __DIR__ . '/../..' . '/modules/reporting/class-pdf-generator.php',
        'OmniPrivacy_PII_Actions' => __DIR__ . '/../..' . '/modules/pii-search/class-pii-actions.php',
        'OmniPrivacy_PII_Field_Scanner' => __DIR__ . '/../..' . '/modules/compat/trait-pii-field-scanner.php',
        'OmniPrivacy_PII_Results' => __DIR__ . '/../..' . '/modules/pii-search/class-pii-results.php',
        'OmniPrivacy_PII_Scanner' => __DIR__ . '/../..' . '/modules/pii-search/class-pii-scanner.php',
        'OmniPrivacy_Portal_Shortcode' => __DIR__ . '/../..' . '/modules/user-portal/class-portal-shortcode.php',
        'OmniPrivacy_Settings' => __DIR__ . '/../..' . '/includes/class-omniprivacy-settings.php',
        'OmniPrivacy_WPForms_Scanner' => __DIR__ . '/../..' . '/modules/compat/class-wpforms-scanner.php',
        'OmniPrivacy_WooCommerce_Scanner' => __DIR__ . '/../..' . '/modules/compat/class-woocommerce-scanner.php',
    ...
    public static function getInitializer(ClassLoader $loader)
    {
        return \Closure::bind(function () use ($loader) {
            $loader->prefixLengthsPsr4 = ComposerStaticInit02f24d5412d2ae22b900a4f2f7ff712b::$prefixLengthsPsr4;
            $loader->prefixDirsPsr4 = ComposerStaticInit02f24d5412d2ae22b900a4f2f7ff712b::$prefixDirsPsr4;
            $loader->classMap = ComposerStaticInit02f24d5412d2ae22b900a4f2f7ff712b::$classMap;
